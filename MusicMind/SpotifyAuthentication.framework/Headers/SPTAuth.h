...
/** Scope that lets you read users collaborative playlists */
FOUNDATION_EXPORT NSString * const SPTAuthPlaylistReadCollaborativeScope;
...
/** Scope that lets you read users top played artists and tracks. */
FOUNDATION_EXPORT NSString * const SPTAuthUserReadTopScope;
